...
class Strategy(ABC):
    ...
    def start(
        ...
        for current_round in range(1, num_rounds + 1):
            ...
            if rotate_malicious_nodes:
                active_attackers = random.sample(malicious_pool, k=active_malicious_nodes_per_round)
            else:
                active_attackers = malicious_pool[:active_malicious_nodes_per_round]
            ...
            #notes
            '''
            1. i should be overwriting superclass or sum + corect pyproject parse + prolly need a bigger batch
